  ...
  getReferences(): HeroListItem[] {
    return [
      ...
      },
      {
        ...
        description: 'Many extensions of the product information system of a big austrian company, including a mass-change tool and a generic exporter',
      ...
      {
        title: 'Phonebook',
        description: 'Internal Phonebook for a big austrian company, including employee-, store-, department data and translation.',
        imagePath: 'assets/references/placeholder.png',
        link: undefined,
        tech: [
          {
